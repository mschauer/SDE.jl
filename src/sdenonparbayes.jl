...
function fe_mu_c(y::Vector{Float64}, L, K)
	...
	N = length(y)
	product = ccall( (:fe_mu_at, "/home/xyz/julia/libsigma.s"),
                  Void,
...
function fe_Sigma_c(y::Vector{Float64}, dt::Float64, L)
	...
	product = ccall( (:fe_Sigma_at, "/home/xyz/julia/libsigma.s"),
                  Void,
...
function fe_SigmaB1_c(y::Vector{Float64}, dt::Float64, L)
	...
	product = ccall( (:fe_SigmaB1_at, "/home/xyz/julia/libsigma.s"),
                  Void,
                  (Ptr{Float64}, Ptr{Float64}, Int32, Float64, Int32),
                  S, y, N, dt, L)
